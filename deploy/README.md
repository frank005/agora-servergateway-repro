...
| `AGORA_REGISTER_LOCAL_USER_OBSERVER` | Set to `1` to register local-user observer callbacks (C++ LL and v2); set `0` to disable. |
| `AGORA_LU_CB_AUDIO_SUB` | Local-user observer callback gate for audio-track-subscribed callback. |
| `AGORA_LU_CB_VIDEO_SUB` | Local-user observer callback gate for video-track-subscribed callback. |
| `AGORA_LU_CB_VOLUME_IND` | Local-user observer callback gate for audio-volume-indication callback. |
